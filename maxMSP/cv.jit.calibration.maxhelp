...
,
		"rect" : [ 59.0, 44.0, 1156.0, 713.0 ],
		"bgcolor" : [ 0.945098, 0.905882, 0.878431, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 885.0, 270.0, 137.0, 51.0 ],
					"text" : "read and write messages asks for two files : intrinsic parameters and distorsion coeff"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 930.0, 330.0, 32.5, 16.0 ],
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 315.0, 165.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 255.0, 150.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 756.0, 270.0, 126.0, 62.0 ],
...
,
					"patching_rect" : [ 325.0, 255.0, 79.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 675.0, 480.0, 174.0, 68.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.0, 306.0, 177.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 515.0, 261.0, 187.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 675.0, 405.0, 174.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 200.0, 175.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 240.0, 56.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 325.0, 663.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 325.0, 178.0, 91.0, 18.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cvtitle.png",
				"bootpath" : "/0labo/max/cv/cv.jit_OSX_v1.7.3-beta/cv.jit-support/Data",
				"patcherrelativepath" : "../../cv/cv.jit_OSX_v1.7.3-beta/cv.jit-support/Data",
				"type" : "PNG ",
				"implicit" : 1
			}
, 			{
				"name" : "cvjit_random_bg_colour.maxpat",
				"bootpath" : "/0labo/max/cv/cv.jit_OSX_v1.7.3-beta/cv.jit Help",
				"patcherrelativepath" : "../../cv/cv.jit_OSX_v1.7.3-beta/cv.jit Help",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
				"name" : "cv.jit.calibration.mxo",
				"type" : "iLaX"
			}
 ]
	}
